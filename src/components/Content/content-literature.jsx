...
import contentLiterature from '../../utils/content-literature.json';
import './content-literature.css';

const Content_literature = () => {
  ...
  return (
    <section className="content-wrapper">
      <div className="paddings innerWidth content-container">
        {/* <h1 className="primaryText" style={{ fontSize: "2.2rem" }}>{contentLiterature.title}</h1> */}
        {contentLiterature.sections.map((section, index) => (
...
export default Content_literature;
